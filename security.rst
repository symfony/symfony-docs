...
.. tip::
    ...
    When logging in on a different firewall, the current and the other firewall
    need to share the same :ref:`firewall context <reference-security-firewall-context>`.
