...
could install the latest 2.x version by adding the following ``require``
...
installed. If you're using Composer, you could get the latest 2.x version
...
install the latest 2.x version, add this to your ``composer.json``:
