...
.. code-block:: terminal
    ...
    $ symfony new my_project_name --version=5.2 --full
...
.. code-block:: terminal
    ...
    # run this if you are building a traditional web application
    $ composer create-project symfony/website-skeleton:"5.2.*" my_project_name

    # run this if you are building a microservice, console application or API
    $ composer create-project symfony/skeleton:"5.2.*" my_project_name
