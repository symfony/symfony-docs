...
.. tip::
    ...
    your dev environment (for instance when using a virtual machine or container where
    only the current project directory is mounted), you can alternatively use the ``--copy`` option.
