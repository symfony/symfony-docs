...
.. tip::
    ...
    remember that all pools perform the same actions but on different media, depending on
    the adapter they are based on. Internally, a pool wraps the definition
    of an adapter.
