...
these services are **autowired** and **private** (e.g. ``public: false``).
...
and "types" (e.g. class or interface names) are now *more* important.
...
.. caution::
    ...
    Services associated with global PHP classes (e.g. not using PHP namespaces)
