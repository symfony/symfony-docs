...
are kept when the widget is removed from the tree. See
:doc:`/tui/topics/events` to remove listeners, register global listeners
and learn about the full event system.
