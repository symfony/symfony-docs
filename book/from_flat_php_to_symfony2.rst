...
Now before we actually start using Symfony2, we need to make sure PHP knows 
where to find the Symfony2 classes. For this, we need to set up the autoloader.
