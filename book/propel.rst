...
does not come integrated with Propel by default, but the integration of both is
...
In Propel world, ActiveRecord classes are known as **models** because classes
...
It will generate all classes to quickly develop your application in the
``Model/`` directory of your bundle named ``AcmeStoreBundle``.
...
.. note::
    ...
    :doc:`route <routing>` that points to this action to see it in work.
...
to waste your time with SQL or whatever, Symfony2 is fully object oriented
...
Assuming you have products in your database, you won't lose them. Thanks to
