...
.. code-block:: bash
    ...
    $ php composer.phar create-project symfony/framework-standard-edition /path/to/webroot/Symfony '~2.7'
...
.. code-block:: bash
    ...
    # for .tgz file
    $ tar zxvf Symfony_Standard_Vendors_2.7.###.tgz

    # for a .zip file
    $ unzip Symfony_Standard_Vendors_2.7.###.zip
