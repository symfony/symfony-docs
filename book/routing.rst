...
.. configuration-block::
    ...
    .. code-block:: php-annotations
        ...
        class MainController extends Controller
        {
             ...
             * @Method("POST")
             */
            public function processContactFormAction()
            {
    ...
    .. code-block:: yaml
        ...
        contact_form_display:
            path:     /contact
            defaults: { _controller: AppBundle:Main:displayContactForm }
            methods:  [GET]

        contact_form_process:
            path:     /contact
            defaults: { _controller: AppBundle:Main:processContactForm }
            methods:  [POST]
    ...
    .. code-block:: xml
        ...
        <routes xmlns="http://symfony.com/schema/routing"
            ...
            <route id="contact_form_display" path="/contact" methods="GET">
                <default key="_controller">AppBundle:Main:displayContactForm</default>
            </route>

            <route id="contact_form_process" path="/contact" methods="POST">
                <default key="_controller">AppBundle:Main:processContactForm</default>
            </route>
        </routes>
    ...
    .. code-block:: php
        ...
        $collection->add('contact_form_display', new Route('/contact', array(
            '_controller' => 'AppBundle:Main:displayContactForm',
        ), array(), array(), '', array(), array('GET')));

        $collection->add('contact_form_process', new Route('/contact', array(
            '_controller' => 'AppBundle:Main:processContactForm',
