...
:class:`Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller` class. They
can implement :class:`Symfony\\Foundation\\DependencyInjection\\ContainerAwareInterface`
interface or extend :class:`Symfony\\Foundation\\DependencyInjection\\ContainerAware`
class instead.
